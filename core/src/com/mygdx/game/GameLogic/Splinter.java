...
public class Splinter extends GameControlledObject {
    public Splinter(ManagerList parent, World W, float x, float y, Tank Owner,float damag) {
        super(parent, W);
